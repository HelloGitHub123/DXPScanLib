...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        if (frame.size.width > 100.0 && frame.size.height > 30.0) {
            ...
            UIView *sView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, width, width/4.0)];
